    ...
    do
    {
        do
        {
            ...
            case '1':
            {
                ...
                printf("Enter your name, surname and patronymic, in type Danil(name) Semakin(surname) Vitalevich(patronymic) then put button enter\n");
                do
                {
                    count = 0;
                    do
                ...
                student.array = malloc(sizeof(int) * size);
                do
                {
                    ...
                    for (i = 0; i < size; i++)
                    {
                        ...
                        {
                            student.array[i] = atoi(buffer_array);
                            check =+ 0;
                        }
                        else
                        {
                            printf("Was entered not a digit\n");
                            check =+ 1;
                        }
